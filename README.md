...
**Музыкальный агрегатор с асинхронной архитектурой**

* **Функционал:** Поиск треков, работа с чартами, прослушивание превью и создание персональных плейлистов с JWT-авторизацией. Для авторизованных пользователей доступны умные фильтры (поиск по старым/новым трекам или по выбору артиста).
...
### ☸️ Kubernetes версия (ветка [k8s_version](https://github.com/MRGiorgiosDev8/musicPlatform_api_django/tree/k8s_version))
